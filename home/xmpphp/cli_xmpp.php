...
$conn = new XMPPHP_XMPP('talk.google.com', 5222, 'data', 'int0uchd@t@', 'xmpphp', 'intouchrewards.com', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_INFO);
$conn->autoSubscribe();
...
print "Here2\n";
    		...
    		switch($event[0]) {
    			...
    			case 'session_start':
    			    print "Session Start\n";
			    	$conn->getRoster();
    				$conn->presence($status="Commands: help, start, stop, total");
    			break;
				case 'vcard':
