...
nFilter.innerHTML = oSettings.oLanguage.sSearch+'&nbsp;<input type="text" /><img id="' + oSettings.sTableId + '_searchIcon" src="../images/sort_asc.png" style="cursor:pointer;" title="Search" />';
