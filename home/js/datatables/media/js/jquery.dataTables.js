...
nFilter.innerHTML = '&nbsp;<input type="text" margin-bottom="2px" /> &nbsp;<img id="' + oSettings.sTableId + '_searchIcon" src="js/datatables/media/images/search5.png" style="cursor:pointer;" title="Search" />';
// nFilter.innerHTML = '<img id="' + oSettings.sTableId + '_searchIcon" src="js/datatables/media/images/search5.png" style="cursor:pointer;" title="Search" />'+'&nbsp;<input type="text" />;';
// 
