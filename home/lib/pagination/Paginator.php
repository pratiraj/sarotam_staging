...
class Paginator {      
        ...
        public function __construct()
        {
            ...
            $this->range        = 5; //range between current page and two ending page numbers.
            $this->currentPage  = 1;       
            $this->total        = 0; //total number of pages.
            $this->textNav      = true;
        ...
        private function  _getPageNumbers()
        {
            ...
            for($i = $start; $i <= $end; $i++){
                    if($end <= "1" && isset($_SESSION['sPagination']) && trim($_SESSION['sPagination'])!=""){
                         echo '<li><a href=""';
