...
function createSupplierFn(){
    window.location.href = "supplier/create";
}
function editSupplier(suppid){
      window.location.href = "supplier/edit/suppid="+suppid;
}
</script>
...
<div class="container-section">
    <div class="row">
        <div class="col-md-12">
            ...
            <button type="button" class="btn btn-primary" onclick="createSupplierFn();">Create Supplier</button>
    <br/><br/>
        </div>
    </div>
    <div class="row">        
        <div class="col-md-12">
            <div class="panel panel-default">
                <h5>&nbsp;&nbsp;<b>Suppliers Master List</b></h5>
