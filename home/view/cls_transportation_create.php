...
class cls_transportation_create extends cls_renderer{
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <h2 class="title-bar">Create Transportation</h2>
                        <div class="common-content-block">   
                             <div class="box box-primary"><br>
                                <form role="form" id="createsupplier" name="createsupplier" enctype="multipart/form-data" method="post" action="formpost/createtransportation.php">
                                    <input type = "hidden" name="form_id" id="form_id" value="createtransportation">
                                    <div class="box-body">
                                ...
                                <?php if ($formResult->form_id == 'createtransportation') { ?>
