...
class cls_po_approvecancel extends cls_renderer{
...
<script type="text/javaScript">   
    ...
    function approvecancelPO(poid){  
      var r = confirm("Are you sure you want to cancel this PO");
       if(r){
        var remarks = $('#remarks').val(); 
        var ajaxURL = "ajax/approvecancelPO.php?poid=" + poid+"&remarks="+remarks;
            //alert(ajaxURL);
            $.ajax({
            url:ajaxURL,
                dataType: 'json',
                success:function(data){
                    ...
                    if (data.error == "1") {
                        ...
                        alert("PO Sucessfully Cancelled.")
                        window.location.href = "po/postatus="+<?php echo POStatus::Cancelled;?>; 
                    }
                }
            }); 
       }
    ...
    function rejectPO(poid){
       var r = confirm("Are you sure you want to reject cancellation of this PO");
       if(r){
        var remarks = $('#remarks').val(); 
        var ajaxURL = "ajax/rejectcancelledPO.php?poid=" + poid+"&remarks="+remarks;
            //alert(ajaxURL);
            $.ajax({
            url:ajaxURL,
                dataType: 'json',
                success:function(data){
                    ...
                    if (data.error == "1") {
                        ...
                        alert("PO Cancellation Sucessfully Rejected.")
                        window.location.href = "po/postatus="+<?php echo POStatus::Submitted;?>;
                    }
                }
            });
       }
...
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.3/css/bootstrap-select.min.css" />        
        ...
        public function pageContent() {
            $menuitem = "approvecancelpo";//pagecode
                    ...
                    <div class="panel-body">
                        ...
                        <div class="common-content-block">
                            <div class="col-md-12">
                             ...
                             <?php if($obj_po->cancelreason != null){?>
                            <div class="col-md-12">
                                <label>PO Cancellation Reason:</label><br>
                                <p><?php echo $obj_po->cancelreason; ?></p>
                            </div>
                             <?php } ?>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <button onclick="approvecancelPO(<?php echo $this->poid;?>);" class="btn btn-primary">Cancel</button>
