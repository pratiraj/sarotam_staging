...
class cls_vendor_edit extends cls_renderer {
    var $params;
    var $currStore;
...
//        $bobj = $db->fetchObject($query);
        $bobj = $dbl->getVendorById($this->vid);
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <h2 class="title-bar">Edit Vendor</h2>
                        <div class="common-content-block"> 
                            <div class="box box-primary">                                            
                                <form class="form-horizontal" id="editvendorform" name="editvendorform"  method="post" action="formpost/editVendor.php">
                                    <input type = "hidden" name="form_id" id="form_id" value="editvendorform">
                                    <div class="box-body">
                                       <div class="form-group">
                                            <label id=name" class="col-md-3 control-label" >Name</label>
                                            <div class="col-md-9">
                                                <input type="hidden"  id="vid" name="vid" value = "<?php echo $this->vid ;?>" >                                               
                                        ...
                                        <div class="form-group">
                                            <label id=name" class="col-md-3 control-label" >Commission Percentage</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="scommper" name="scommper" style="margin-top: 5px;" value = "<?php echo $bobj->comission_per ;?>">
                                ...
                                <?php if ($formResult->form_id == 'editvendorform') { ?>
