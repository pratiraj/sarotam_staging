...
class cls_po_approved extends cls_renderer{
...
<script type="text/javaScript">   
    ...
    function submitPO(poid){  
       var r = confirm("Are you sure you want to submit this PO");
       if(r){
        var remarks = $('#remarks').val();
        var ajaxURL = "ajax/submitPO.php?poid=" + poid;
            //alert(ajaxURL);
            $.ajax({
            url:ajaxURL,
                dataType: 'json',
                    ...
                    <div class="panel-body">
                        ...
                        <div class="common-content-block">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php }?>
                                <div class="col-md-12">
                                    <button onclick="submitPO(<?php echo $this->poid;?>);" class="btn btn-primary">Submit</button>
                                </div>
                            </div>    
                        </div>
                    </div>
