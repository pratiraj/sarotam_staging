...
//        }); 
//        
//        var ajaxPUrl = "ajax/getUserNotAssgndLocFuncPgs.php?userid="+userid+"&location_id="+loc_id;
//        alert(ajaxPUrl);
//        $.getJSON(ajaxPUrl, function(data) {
//           $("#selectRight").empty();
//            for (var i = 0; i < data.length; i++) {               
...
//                alert(multiplevalues2);
                //alert("formpost/assignLFuncsToUser.php?user_id="+seluser+"&location_id="+sellocation+"&to_enable_pgs="+multiplevalues+"&to_disable_pgs="+multiplevalues2);
                window.location.href="formpost/assignLFuncsToUser.php?user_id="+seluser+"&location_id="+sellocation+"&to_enable_pgs="+multiplevalues+"&to_disable_pgs="+multiplevalues2;                           
       } else {
    ...
    <div class="row">        
        <div class="col-md-12">
            <div class="content-block table-task">
               ...
               <div class="col-md-6">
                    <select id="seluser" name="seluser" class="chzn-select" style="width:75%" single onchange="getByUserSelect(this.value);" >
               ...
               <div class="col-md-6">
                    <select id="sellocation" name="sellocation" class="chzn-select" style="width:75%" single onchange="getByLocSelect(this.value);">
