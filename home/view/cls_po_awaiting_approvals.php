...
class cls_po_awaiting_approvals extends cls_renderer{
...
$(function(){     
    var url = "ajax/tb_purchase_order_approve.php?status="+<?php echo $this->postatus; ?>   
...
function viewPO(poid){
    window.location.href = "po/approve/poid="+poid;
}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <h7><b>&nbsp;&nbsp;&nbsp;&nbsp;Purchase Order Awaiting Approval</b></h7>
