...
class cls_rfc_create extends cls_renderer{
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <h2 class="title-bar">Create Retail Franchisee Outlet</h2>
                        <div class="common-content-block">   
                             <div class="box box-primary"><br>
                                <form role="form" id="createrfc" name="createrfc" enctype="multipart/form-data" method="post" action="formpost/createrfc.php">
                                    <input type = "hidden" name="form_id" id="form_id" value="createrfc">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="RFC Name" value="<?php echo $this->getFieldValue("name"); ?>">
                                        </div>
                                        <div class="form-group">
                                ...
                                <?php if ($formResult->form_id == 'createrfc') { ?>
