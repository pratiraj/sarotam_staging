...
$objPHPExcel->getActiveSheet()->setCellValue('H1', 'Qty (Kg.)');
$objPHPExcel->getActiveSheet()->setCellValue('I1', 'Rate (Rs./Kg)');
...
//         $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $rowCount, $obj->length);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $rowCount, $obj->qty);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $rowCount, $obj->price);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $rowCount, $obj->value);
