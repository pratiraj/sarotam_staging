...
//                                                print"<br>update in portal db"; 
                                                ...
                                                $dbLogic->updateProduct($category_id,$uom_id,$pack_size_id,$pobj->id,$rate,null,null,$userid,$user->location_id);
                                            }else{
//                                                print"<br>in insert product in portal db";                                                                        
                                                $dbLogic->insertProduct($category_id,$uom_id,$pack_size_id,$itemname,$json,$prodrefid,$variant_id,$handle,$rate,$userid,$user->location_id);
                                            }
                                        }else{  // else missing
