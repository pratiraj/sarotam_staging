...
$objPHPExcel->getActiveSheet()->setCellValue('E1', 'batchcode');
$objPHPExcel->getActiveSheet()->setCellValue('F1', 'Desc1');
$objPHPExcel->getActiveSheet()->setCellValue('G1', 'Desc2');
$objPHPExcel->getActiveSheet()->setCellValue('H1', 'Thickness');
$objPHPExcel->getActiveSheet()->setCellValue('I1', 'HSN Code');
$objPHPExcel->getActiveSheet()->setCellValue('J1', 'Qty (Kg.)');
$objPHPExcel->getActiveSheet()->setCellValue('K1', 'No Of Pieces');
$objPHPExcel->getActiveSheet()->setCellValue('L1', 'Rate (Rs./Kg)');
$objPHPExcel->getActiveSheet()->setCellValue('M1', 'CGST');
$objPHPExcel->getActiveSheet()->setCellValue('N1', 'SGST');
$objPHPExcel->getActiveSheet()->setCellValue('O1', 'Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('P1', 'Createtime');
...
$result = $dbl->getGrnStockSummery($dcid);
    ...
    foreach ($result as $obj) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $rowCount, $obj->grnno);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $rowCount, $obj->name);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $rowCount, $obj->batchcode);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $rowCount, $obj->desc1);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $rowCount, $obj->desc2);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $rowCount, $obj->thickness);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $rowCount, $obj->hsncode);  
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $rowCount, $obj->qty);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $rowCount, $obj->no_of_pieces);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14, $rowCount, $obj->totalvalue);//grndate
        //$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $rowCount, $obj->createtime);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $rowCount, $obj->grndate);  
