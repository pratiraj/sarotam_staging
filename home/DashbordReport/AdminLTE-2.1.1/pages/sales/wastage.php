...
<!--                    <div class="navbar-custom-menu">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2" style="margin-left: 2em">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <button onclick="downloadWastageData();">Export</button>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($store_id) && $store_id != "") {
                                                if (isset($date) && $date != "") {
                                                    ...
                                                    $query = "select p.name,p.uom,p.cost_price,t.quantity,t.reason from it_products p,it_transaction_items t,it_transactions tr,it_store_products s where t.product_id = s.id and p.id = s.product_id and tr.transaction_type = 3 and t.transaction_id = tr.id and tr.store_id = $store_id and date(tr.tran_date) between $date_1 and $date_2";   
                                                } else {
                                                    $query = "select p.name,p.uom,p.cost_price,t.quantity,t.reason from it_products p,it_transaction_items t,it_transactions tr,it_store_products s where t.product_id = s.id and p.id = s.product_id and tr.transaction_type = 3 and t.transaction_id = tr.id and tr.store_id = $store_id";
                                                }
                                            } else {
                                                $query = "select p.name,p.uom,p.cost_price,t.quantity,t.reason from it_products p,it_transaction_items t,it_transactions tr,it_store_products s where t.product_id = s.id and p.id = s.product_id and tr.transaction_type = 3 and t.transaction_id = tr.id and tr.store_id = -1";
                                            }
                                            ...
                                            foreach ($obj as $user) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $user->cost_price; ?></td>
        ...
        <script type="text/javascript">
                                        ...
                                        function downloadWastageData() {

                                                var store = document.getElementById('store').value;
                                                var date = document.getElementById('reservation').value;
//                                                alert(store+":"+date);
                                                if (store !== -1 && date === "") {
                                                    window.location.href = "../../../../formpost/generateWastageData.php?sid=" + store;
                                                } else if (store !== -1 && date !== "") {
                                                    window.location.href = "../../../../formpost/generateWastageData.php?sid=" + store + "&date=" + date;
                                                }
                                            }
        </script>
