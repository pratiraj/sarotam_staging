...
try{
    ...
    $status = ProductPriceStatus::Disapproved;
    //echo "CR Id : ".$crid;
    if($crid == NULL || $prodid == NULL){
        ...
        //$dbl->disapproveProductPrice($status,$todaysdate,$prodid,$crid,$userid);
        $dbl->disapproveProductPrice($status,$uploaddate,$prodid,$crid,$userid);
