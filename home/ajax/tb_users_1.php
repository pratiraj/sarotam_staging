...
$aColumns = array('name','address','phone','username','is_active','action');
$sColumns = array('name','address','phone','username','is_active');
	...
	for ( $i=0 ; $i<count($aColumns) ; $i++ )
	{
             if ($aColumns[$i] == 'name') {
                ...
                $row[] = $status;                
                 ...
                 $row[] = '<button type="button" onclick="editUser(' . $obj->id . ')">Edit</button>';            
             }else{
                 $row[] = "-";
             }   
