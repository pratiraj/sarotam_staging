...
$sQuery = "
	select SQL_CALC_FOUND_ROWS i.id,i.customer_id,i.invoice_no,i.saledate,i.createtime,i.cname,i.cphone,i.total_qty,i.total_tax,i.total_amount from $tablename i
	$sWhere 
	$sOrder
	$sLimit
";
